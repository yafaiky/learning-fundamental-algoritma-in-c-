...
classes loadClass(char c[]){
	if(strcmp(c, "Asep Racing") == 0){
		playerCharacter._class = _class[0];
	}
	else if(strcmp(c, "Mas Amba") == 0){
...
void newGame(){
	...
	}while(strcmp(tempclass, "Asep racing") == 1 &&
			strcmp(tempclass, "Mas Amba") == 1 &&
			strcmp(tempclass, "Mas Rusdi") == 1);
...
void fightMenu(){
	...
	do{
		system("cls");
		printf("Fight Menu\n==========\n");
		printf("1. Kopling Racing\n");
		printf("2. Gahar Membahana\n");
		printf("3. Topi Miring\n");
		printf("4. Back\n");
		printf(">> ");
